...
export default {
  ...
  data() {
    return {
      ...
      data: [{ name: 'intelli-warehouse-', timestamp: new Date(), threadName: 'system-prompt-message', level: 'INFO', className: 'edu.jmu.AppRun' + ' :', body: 'Welcome, no log output' }],
      // level
    ...
    connection(_this) {
      ...
      this.stompClient.connect(headers, (frame) => {
        this.stompClient.subscribe('/topic/logMsg', (msg) => { // 订阅服务端提供的某个topic
          ...
          content.name = 'intelli-warehouse'
