...
帐号密码公开，供测试使用，存入数据库的密码会加密处理，请文明测试</pre>
 ...
 account.setHost("smtp.jmu.edu.cn");
 account.setPort("465");
 account.setAuth(true);
 account.setFrom("200561000172@jmu.edu.cn");
 account.setUser("200561000172");
 account.setPass("pass");
 # 倒数第二个参数：是否为http格式
 MailUtil.send(account, CollUtil.newArrayList("gtm@edu.jmu.cn"), "测试", "邮件来自智能仓储测试", true，file...);</pre>
